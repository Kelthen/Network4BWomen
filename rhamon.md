...
- **Données / Auth / Storage** : Supabase (client dans `lib/supabase.ts`). Schéma dans `docs/DATA-MODEL.md` + migrations dans `supabase/`.
...
| `docs/CONTENT.md` | Sitemap & contenu des pages | humains, par PR |
| `docs/DATA-MODEL.md` | Schéma Supabase | les deux, par migration |
