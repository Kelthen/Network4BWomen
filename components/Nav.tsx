      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-4 font-sub" aria-label="Main">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/search"
            aria-label="Search"
            className={`flex h-10 w-10 items-center justify-center rounded-full border border-brand-beige transition hover:text-brand-pink ${
              pathname === "/search" ? "text-brand-pink" : "text-brand-brown"
            }`}
          >
      ...
      {open && (
        <div id="mobile-menu" className="max-h-[80vh] overflow-y-auto border-t border-brand-beige bg-brand-cream font-sub lg:hidden">
          <ul className="mx-auto flex max-w-7xl flex-col px-4 py-2">
            <li className="border-b border-brand-beige/60 py-2">
              <Link
                href="/search"
                className={`block py-2 text-base font-semibold ${pathname === "/search" ? "text-brand-pink" : "text-brand-brown"}`}
              >
                Search
              </Link>
            </li>
