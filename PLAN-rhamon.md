...
- [ ] **Layout global** (`app/layout.tsx`, `components/Nav.tsx`, `components/Footer.tsx`, `components/LandAcknowledgment.tsx`) — Nav + Footer + reconnaissance territoriale (Alberta / Blackfoot Confederacy).
